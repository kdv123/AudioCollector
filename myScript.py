...
plt.savefig('C:/Users/sel49/workspace/AudioCollector/myTone.png')

plt.savefig('C:/Users/sel49/Desktop/'+ sys.argv[1] + '.png')
#plt.show()
...
##
##numUniquePoints = numpy.ceil((mySoundLength + 1) / 2.0).astype(int)
##print('num unique pts' + numUniquePoints.astype(str))
...
###plt.ylabel('Power (dB)')
####fig, ax = plt.subplots()
####ax.plot(freqArray/1000, 10 * numpy.log10 (fftArray), color='B')
####ax.set(xlabel='Frequency (Khz)', ylabel='Power(db)')
###plt.savefig('C:\\Users\\sel49\\Desktop\\two.png', bbox_inches='tight')
###plt.savefig('C:\\Users\\sel49\\Desktop\\two1.png', bbox_inche
###plt.close(fig)
##
##
